...
module.exports = {
  rules: {
    ...
    'max-len': [ 'error', { code: 120, comments: 80, tabWidth: 2, ignoreUrls: true, ignorePattern: '^\\s*\\* @\\S', ignoreStrings: true, ignoreTemplateLiterals: true, ignoreRegExpLiterals: true } ],
